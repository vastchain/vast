...
from pyvast import vast_link
from pyvastsdk import api, base
from pyvastsdk.action import ActionGenerator
from pyvastsdk.transaction import TrxGenerator
...
class PayEngine:
    ...
    def build_vast_link(self, user):
        link = vast_link.VastLink()
        link.set_header(5)
    ...
    def everipay(self):
        ...
        user1_link = self.build_vast_link(user1)
        if self.wp.alive:
