...
class Test(unittest.TestCase):
    ...
    def test_1(self):
        p = subprocess.Popen(['pumba', 'netem', '--tc-image', 'gaiadocker/iproute2', '--duration', '5m', 'delay', '--time', '1000', '--jitter', '500', 'vastd_0'],
    ...
    def test_2(self):
        p = subprocess.Popen(['pumba', 'netem', '--tc-image', 'gaiadocker/iproute2', '--duration', '5m', 'loss', '--percent', '20', 'vastd_0'],
                             stdin=subprocess.DEVNULL, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, shell=False)
        time.sleep(2)
        self._test_block(20)
        print('kill')
