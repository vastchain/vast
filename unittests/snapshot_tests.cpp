...
#define PUT_DB_TOKEN(TYPE, PREFIX, KEY, VALUE)                                                             \
    {                                                                                                      \
        ...
        tokendb.put_token(vast::chain::token_type::TYPE, action_op::put, PREFIX, KEY, dv.as_string_view()); \
    }
...
TEST_CASE("snapshot_pretest", "[snapshot]") {
    ...
    auto addr = public_key_type(std::string("VAST8MGU4aKiVzqMtWi9zLpu8KuTHZWjQQrX475ycSxEkLd6aBpraX"));
