...
#define UPD_DB_TOKEN(TYPE, NAME, VALUE)                                                                         \
    {                                                                                                     \
        tokendb_cache.put_token(vast::chain::token_type::TYPE, action_op::update, std::nullopt, NAME, VALUE); \
    }
...
public:
    contracts_test() {
        auto basedir = vast_unittests_dir + "/contracts_tests";
        ...
        key_seeds.push_back("vast");
        key_seeds.push_back("vast2");
        ...
        my_tester->add_money(payer, asset(1'000'000'000'000, vast_sym()));
