...
TEST_CASE("test_lua_db", "[luajit]") {
    ...
    auto cfg = vast::chain::controller::config();
    ...
    const char* test_data = R"=====(
    {
        ...
        "metas": [
            { "key": "tm1", "value": "hello1", "creator": "[A] VAST6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV" },
            { "key": "tm2", "value": "hello2", "creator": "[A] VAST5ve9Ezv9vLZKp1NmRzvB5ZoZ21YZ533BSB2Ai2jLzzMep6biU2" }
        ]
    }
    )=====";
