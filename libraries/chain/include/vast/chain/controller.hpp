...
using contracts::vast_link_object;
...
public:
    ...
    vast_link_object get_link_obj_for_link_id(const link_id_type&) const;
    ...
    public_keys_set get_vastlink_signed_keys(const link_id_type& link_id) const;
...
FC_REFLECT(vast::chain::controller::config,
           (blocks_dir)
           (state_dir)
           (state_size)
