...
CHAINBASE_SET_INDEX_TYPE(vast::chain::transaction_object, vast::chain::transaction_multi_index);
FC_REFLECT(vast::chain::transaction_object, (expiration)(trx_id)(block_num));
