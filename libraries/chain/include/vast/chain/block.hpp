...
struct transaction_receipt_header {
    ...
    enum type_enum {
        ...
        suspend = 1   /// Suspend transaction, generated by vast contract
    };
...
FC_REFLECT_ENUM(vast::chain::transaction_receipt::status_enum, (executed)(soft_fail)(hard_fail)(expired));
FC_REFLECT_ENUM(vast::chain::transaction_receipt::type_enum, (input)(suspend));

FC_REFLECT(vast::chain::transaction_receipt_header, (status)(type));
FC_REFLECT_DERIVED(vast::chain::transaction_receipt, (vast::chain::transaction_receipt_header), (trx));
FC_REFLECT_DERIVED(vast::chain::signed_block, (vast::chain::signed_block_header), (transactions)(block_extensions));
