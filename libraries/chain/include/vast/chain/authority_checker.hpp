...
#include <vast/chain/contracts/lua_engine.hpp>
#include <vast/utilities/parallel_markers.hpp>
...
#define READ_DB_TOKEN(TYPE, PREFIX, KEY, VPTR, EXCEPTION, FORMAT, ...)       \
    try {                                                                    \
        ...
        VAST_THROW2(EXCEPTION, FORMAT, __VA_ARGS__);                          \
    }
...
private:
    ...
    const vast_execution_context& exec_ctx_;
...
public:
    authority_checker(const controller& control, const vast_execution_context& exec_ctx, const public_keys_set& signing_keys, uint32_t max_recursion_depth, bool check_script = true)
        : control_(control)
        , exec_ctx_(exec_ctx)
...
struct check_authority<N(newdomain)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `newdomain` type.");
        return false;
    }
};
...
struct check_authority<N(newgroup)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `newgroup` type.");
        return false;
    }
};
...
struct check_authority<N(newfungible)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transation data is not valid, data cannot cast to `newfungible` type");
        return false;
    }
};
...
template<>
struct check_authority<N(vast2pvast)> {
    template <typename Type>
    static bool
    invoke(const action& act, authority_checker* checker) {
        return checker->satisfied_fungible_permission<kTransfer>(get_symbol_id(act.key), act);
...
struct check_authority<N(newsuspend)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `newsuspend` type.");
        return false;
    }
};
...
struct check_authority<N(execsuspend)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `execsuspend` type.");
        return false;
    }
};
...
struct check_authority<N(addmeta)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `addmeta` type.");
    }
};
...
struct check_authority<N(prodvote)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `prodvote` type.");
    }
};
...
struct check_authority<N(updsched)> {
    ...
    invoke(const action&, authority_checker* checker) {
        return checker->satisfied_group(checker->get_control().get_genesis_state().vast_org.name());
    }
};
...
struct check_authority<N(newlock)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `newlock` type.");
        return false;
    }
};
...
struct check_authority<N(aprvlock)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `aprvlock` type.");
        return false;
    }
};
...
struct check_authority<N(tryunlock)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `tryunlock` type.");
        return false;
    }
};
...
struct check_authority<N(newvalidator)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `newvalidator` type.");
        return false;
    }
};
...
struct check_authority<N(staketkns)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `staketkns` type.");
        return false;
    }
};
...
struct check_authority<N(unstaketkns)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `unstaketkns` type.");
        return false;
    }
};
...
struct check_authority<N(toactivetkns)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `toactivetkns` type.");
        return false;
    }
};
...
struct check_authority<N(newscript)> {
    ...
    invoke(const action& act, authority_checker* checker) {
        ...
        VAST_RETHROW_EXCEPTIONS(action_type_exception, "transaction data is not valid, data cannot cast to `addscript` type.");
        return false;
    }
};
