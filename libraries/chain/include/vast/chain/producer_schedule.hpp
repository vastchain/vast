...
struct shared_producer_schedule_type {
    ...
    operator=(const producer_schedule_type& a) {
        version = a.version;
        producers.clear();
...
FC_REFLECT(vast::chain::producer_key, (producer_name)(block_signing_key));
FC_REFLECT(vast::chain::producer_schedule_type, (version)(producers));
FC_REFLECT(vast::chain::shared_producer_schedule_type, (version)(producers));
