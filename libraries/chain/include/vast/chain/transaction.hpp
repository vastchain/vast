...
FC_REFLECT(vast::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)(max_charge));
FC_REFLECT_ENUM(vast::chain::transaction_ext, (suspend_name));
FC_REFLECT_DERIVED(vast::chain::transaction, (vast::chain::transaction_header), (actions)(payer)(transaction_extensions));
FC_REFLECT_DERIVED(vast::chain::signed_transaction, (vast::chain::transaction), (signatures));
FC_REFLECT_ENUM(vast::chain::packed_transaction::compression_type, (none)(zlib));
// @ignore unpacked_trx
FC_REFLECT(vast::chain::packed_transaction, (signatures)(compression)(packed_trx));
