...
struct genesis_state {
    ...
    static const string vast_root_key;
    ...
    chain_config initial_configuration = {
        ...
        .vast_link_expired_secs          = config::default_vast_link_expired_secs
    };
    ...
    group_def            vast_org;
    fungible_def_genesis vast;
    fungible_def_genesis pvast;
    ...
    // Get VAST & PVAST FTs
    fungible_def get_vast_ft() const;
    fungible_def get_pvast_ft() const;
...
FC_REFLECT(vast::chain::genesis_state,
           (initial_timestamp)(initial_key)(vast_org)(vast)(pvast)(initial_configuration));
