...
class variant;
void to_variant(const vast::chain::contracts::group& group, fc::variant& v);
void from_variant(const fc::variant& v, vast::chain::contracts::group& group);

}  // namespace fc

FC_REFLECT(vast::chain::contracts::group::node, (weight)(threshold)(index)(size));
FC_REFLECT(vast::chain::contracts::group, (name_)(key_)(nodes_)(keys_)(metas_));
