...
public:
    static vast_link parse_from_vastli(const std::string& str);
...
private:
    friend struct fc::reflector<vast_link>;
};
...
class variant;
void to_variant(const vast::chain::contracts::vast_link& link, fc::variant& v);
void from_variant(const fc::variant& v, vast::chain::contracts::vast_link& link);

}  // namespace fc

FC_REFLECT(vast::chain::contracts::vast_link::segment, (key)(intv)(strv));
FC_REFLECT(vast::chain::contracts::vast_link, (header_)(segments_)(signatures_));
