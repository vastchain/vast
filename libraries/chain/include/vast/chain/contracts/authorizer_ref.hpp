...
class variant;
void to_variant(const vast::chain::contracts::authorizer_ref& ref, fc::variant& v);
void from_variant(const fc::variant& v, vast::chain::contracts::authorizer_ref& ref);

}  // namespace fc

FC_REFLECT(vast::chain::contracts::authorizer_ref::script_name_t, (name));
FC_REFLECT(vast::chain::contracts::authorizer_ref, (storage_));
