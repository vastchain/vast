...
using action_name = vast::chain::action_name;
...
FC_REFLECT(vast::chain::contracts::type_def, (new_type_name)(type));
FC_REFLECT(vast::chain::contracts::field_def, (name)(type));
FC_REFLECT(vast::chain::contracts::struct_def, (name)(base)(fields));
FC_REFLECT(vast::chain::contracts::variant_def, (name)(fields));
FC_REFLECT(vast::chain::contracts::enum_def, (name)(integer)(fields));
FC_REFLECT(vast::chain::contracts::abi_def, (types)(structs)(variants)(enums));
