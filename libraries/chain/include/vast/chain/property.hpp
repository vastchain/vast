...
FC_REFLECT(vast::chain::property, (amount)(frozen_amount)(sym)(created_at)(created_index));
FC_REFLECT_ENUM(vast::chain::stake_type, (active)(fixed));
FC_REFLECT_ENUM(vast::chain::stake_status, (staked)(pending_unstake));
FC_REFLECT(vast::chain::stakeshare_def, (validator)(units)(net_value)(time)(type)(fixed_days));
FC_REFLECT_DERIVED(vast::chain::property_stakes, (vast::chain::property), (stake_shares)(pending_shares));
