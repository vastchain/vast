#include <vast/testing/tester_network.hpp>

namespace vast { namespace testing {
...
void
tester_network::disconnect_all() {
    blockchains.clear();
}

void
tester_network::propagate_block(const signed_block& block, const base_tester& skip_blockchain) {
    ...
    //     pair.first->control->push_block(block, vast::chain::validation_steps::created_block);
    //  }
}

}}  // namespace vast::testing
