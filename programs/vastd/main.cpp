...
main(int argc, char** argv) {
    try {
        app().set_version(vast::vastd::config::version);

        auto root = fc::app_path();
        app().set_default_data_dir(root / "vast/vastd/data");
        app().set_default_config_dir(root / "vast/vastd/config");
        http_plugin::set_defaults({
            .default_unix_socket_path = "vastd.sock",
