...
namespace vast { namespace client { namespace help {
bool print_recognized_errors(const fc::exception& e, const bool verbose_errors) {
   // vast recognized error code is from 3000000 to 3999999
   // refer to libraries/chain/include/vast/chain/exceptions.hpp
