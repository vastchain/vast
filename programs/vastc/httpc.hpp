...
const std::string get_vast_actions             = chain_func_base + "/get_actions";
const std::string get_vast_abi                 = chain_func_base + "/get_abi";
...
const std::string vast_func_base                = "/v1/vast";
const std::string get_domain_func              = vast_func_base + "/get_domain";
const std::string get_token_func               = vast_func_base + "/get_token";
const std::string get_tokens_func              = vast_func_base + "/get_tokens";
const std::string get_group_func               = vast_func_base + "/get_group";
const std::string get_fungible_func            = vast_func_base + "/get_fungible";
const std::string get_fungible_balance_func    = vast_func_base + "/get_fungible_balance";
const std::string get_fungible_psvbonus_func   = vast_func_base + "/get_fungible_psvbonus";
const std::string get_suspend_func             = vast_func_base + "/get_suspend";
const std::string get_lock_func                = vast_func_base + "/get_lock";
const std::string get_stakepool_func           = vast_func_base + "/get_stakepool";
const std::string get_validator_func           = vast_func_base + "/get_validator";
const std::string get_staking_shares_func      = vast_func_base + "/get_staking_shares";
const std::string get_vastlink_signed_keys_func = vast_func_base + "/get_vastlink_signed_keys";
const std::string get_script_func              = vast_func_base + "/get_script";
...
const string vastwd_stop = "/v1/vastwd/stop";
