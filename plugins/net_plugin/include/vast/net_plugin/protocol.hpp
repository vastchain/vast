...
FC_REFLECT(vast::select_ids<fc::sha256>, (mode)(pending)(ids));
FC_REFLECT(vast::chain_size_message,
           (last_irreversible_block_num)(last_irreversible_block_id)(head_num)(head_id));
FC_REFLECT(vast::handshake_message,
...
FC_REFLECT(vast::go_away_message, (reason)(node_id));
FC_REFLECT(vast::time_message, (org)(rec)(xmt)(dst));
FC_REFLECT(vast::notice_message, (known_trx)(known_blocks));
FC_REFLECT(vast::request_message, (req_trx)(req_blocks));
FC_REFLECT(vast::sync_request_message, (start_block)(end_block));
