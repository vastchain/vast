...
#include <vast/producer_api_plugin/producer_api_plugin.hpp>
...
namespace vast { namespace detail {
...
FC_REFLECT(vast::detail::producer_api_plugin_response, (result));
...
#define INVOKE_V_R(api_handle, call_name, in_param)                   \
    ...
    vast::detail::producer_api_plugin_response result{"ok"};

#define INVOKE_V_R_R(api_handle, call_name, in_param0, in_param1)             \
    const auto& vs = fc::json::json::from_string(body).as<fc::variants>();    \
    api_handle.call_name(vs.at(0).as<in_param0>(), vs.at(1).as<in_param1>()); \
    vast::detail::producer_api_plugin_response<std::string> result{"ok"};
