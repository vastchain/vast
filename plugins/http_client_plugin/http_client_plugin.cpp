...
void
http_client_plugin::set_program_options(options_description&, options_description& cfg) {
    cfg.add_options()
...
void
http_client_plugin::plugin_initialize(const variables_map& options) {
    try {
...
void
http_client_plugin::plugin_startup() {
}
