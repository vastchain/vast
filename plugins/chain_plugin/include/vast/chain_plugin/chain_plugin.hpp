...
public:
    ...
    // return true if --skip-transaction-signatures passed to vastd
...
FC_REFLECT(vast::chain_apis::empty, );
FC_REFLECT(vast::chain_apis::read_only::get_info_results,
          (server_version)(chain_id)(vast_api_version)(head_block_num)(last_irreversible_block_num)(last_irreversible_block_id)
          (head_block_id)(head_block_time)(head_block_producer)(enabled_plugins)(server_version_string));
FC_REFLECT(vast::chain_apis::read_only::get_charge_info_results, (base_network_charge_factor)(base_storage_charge_factor)(base_cpu_charge_factor)(global_charge_factor));
FC_REFLECT(vast::chain_apis::read_only::get_block_params, (block_num_or_id));
FC_REFLECT(vast::chain_apis::read_only::get_block_header_state_params, (block_num_or_id));
FC_REFLECT(vast::chain_apis::read_only::get_transaction_params, (block_num)(id));
FC_REFLECT(vast::chain_apis::read_only::get_trx_id_for_link_id_params, (link_id));
FC_REFLECT(vast::chain_apis::read_only::producer_info, (producer_name));
FC_REFLECT(vast::chain_apis::read_only::abi_json_to_bin_params, (action)(args));
FC_REFLECT(vast::chain_apis::read_only::abi_json_to_bin_result, (binargs));
FC_REFLECT(vast::chain_apis::read_only::abi_bin_to_json_params, (action)(binargs));
FC_REFLECT(vast::chain_apis::read_only::abi_bin_to_json_result, (args));
FC_REFLECT(vast::chain_apis::read_only::trx_json_to_digest_result, (digest)(id));
FC_REFLECT(vast::chain_apis::read_only::get_required_keys_params, (transaction)(available_keys));
FC_REFLECT(vast::chain_apis::read_only::get_required_keys_result, (required_keys));
FC_REFLECT(vast::chain_apis::read_only::get_suspend_required_keys_params, (name)(available_keys));
FC_REFLECT(vast::chain_apis::read_only::get_suspend_required_keys_result, (required_keys));
FC_REFLECT(vast::chain_apis::read_only::get_charge_params, (transaction)(sigs_num));
FC_REFLECT(vast::chain_apis::read_only::get_charge_result, (charge));
FC_REFLECT(vast::chain_apis::read_only::validator_slim, (name)(current_net_value)(total_units)(commission));
FC_REFLECT(vast::chain_apis::read_only::get_staking_result, (period_version)(period_start_num)(next_period_num)(validators));
FC_REFLECT(vast::chain_apis::read_only::get_transaction_ids_for_block_params, (block_id));
FC_REFLECT(vast::chain_apis::read_write::push_transaction_results, (transaction_id)(processed));
