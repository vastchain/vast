...
using vast::chain::action_name;
using vast::chain::domain_name;
using vast::chain::public_key_type;
using vast::chain::symbol_id_type;
using vast::chain::token_name;
...
FC_REFLECT_ENUM(vast::history_apis::direction, (asc)(desc));
FC_REFLECT(vast::history_apis::read_only::get_params, (keys));
FC_REFLECT(vast::history_apis::read_only::get_tokens_params, (keys)(domain));
FC_REFLECT(vast::history_apis::read_only::get_actions_params, (domain)(key)(dire)(names)(skip)(take));
FC_REFLECT(vast::history_apis::read_only::get_fungible_actions_params, (sym_id)(dire)(addr)(skip)(take));
FC_REFLECT(vast::history_apis::read_only::get_fungibles_balance_params, (addr));
FC_REFLECT(vast::history_apis::read_only::get_transaction_params, (id));
FC_REFLECT(vast::history_apis::read_only::get_transactions_params, (keys)(dire)(skip)(take));
FC_REFLECT(vast::history_apis::read_only::get_fungible_ids_params, (skip)(take));
