...
FC_REFLECT(vast::error_results::error_info::error_detail, (message)(file)(line_number)(method));
FC_REFLECT(vast::error_results::error_info, (code)(name)(what)(details));
FC_REFLECT(vast::error_results, (code)(message)(error));
FC_REFLECT(vast::http_plugin::get_supported_apis_result, (apis));
