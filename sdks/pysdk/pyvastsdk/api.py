...
class Api:
    def __init__(self, host='https://testnet1.everitoken.io:8888'):
        ...
        self.urls = {
            ...
            'get_domain': '/v1/vast/get_domain',
            'get_group': '/v1/vast/get_group',
            'get_token': '/v1/vast/get_token',
            'get_tokens': '/v1/vast/get_tokens',
            'get_fungible': '/v1/vast/get_fungible',
            'get_assets': '/v1/vast/get_fungible_balance',
            ...
            'get_trx_id_for_link_id': '/v1/vast_link/get_trx_id_for_link_id',
